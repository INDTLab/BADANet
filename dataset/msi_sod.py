...
class MSISOD_TestDataset(_BaseSODDataset):
    def __init__(self, root: Tuple[str, dict], shape: Dict[str, int], interp_cfg: Dict = None):
        ...
        # self.total_image_paths_f = self.datasets["image_f"]
        # self.total_image_paths_b = self.datasets["image_b"]
    ...
    def __getitem__(self, index):
        ...
        image_path_f = self.total_image_paths_f[index]
        image_path_b = self.total_image_paths_b[index]
        mask_path = self.total_mask_paths[index]
        image = Image.open(image_path).convert("RGB")
        # image_f = Image.open(image_path_f).convert("RGB")
        ...
        # image_1_5 = image_f.resize((base_h, base_w), resample=Image.BILINEAR)
        ...
        # image_0_5 = image_b.resize((base_h, base_w), resample=Image.BILINEAR)
