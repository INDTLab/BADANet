...
class Focus1(nn.Module):
    def __init__(self, channel1, channel2):
        ...
        self.a1 = AdaptiveVanillaCrossAttention(dim=self.channel1, bias=False) # 标准MHSA消融
        self.a2 = AdaptiveVanillaCrossAttention(dim=self.channel1, bias=False) # 标准MHSA消融
