...
class CAMO(BasicModelClass):
    ...
    def body(self, m_scale):
        ...
        # edge5, edge4, edge3, edge2, edge1 = self.ncd1(feats[0], feats[1], feats[2],
        #                                               feats[3], feats[4])
        #
        # edge0 = self.d0(edge3)
        # # edge0 = e_x
